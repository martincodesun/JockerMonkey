...
var StaffEvaluationSys = function() {
    ...
    goldApi.defineMapProperty(this, "staff_list", {
        parse: function (text) {
    ...
    goldApi.defineProperty(this, "staff_list_size");
    // 定义一个存储string的list
    goldApi.defineMapProperty(this, "staff_list_array");

    goldApi.defineMapProperty(this, "evaluation_list", {
        parse: function (text) {
    ...
    goldApi.defineProperty(this, "evaluation_list_size");
    // 定义一个存储string的list
    goldApi.defineMapProperty(this, "evaluation_list_array");
...
StaffEvaluationSys.prototype = {
    ...
    init: function() {
        if (this.staff_list_size == null) {
            this.staff_list_size = 0;
        }
        if (this.evaluation_list_size == null) {
...
window.StaffEvaluationSys = StaffEvaluationSys;